...
<c:set scope="session" var="perfil" value='<%= request.getSession().getAttribute("perfil").toString() %>'></c:set> <!-- atributo definido na ServletLogin-->
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                ...
                                <c:if test="${ imagemUser == null || imagemUser == ''}">
                                	<img class="img-80 img-radius" src="<%= request.getContextPath() %>/assets/images/avatar.png" alt="User-Profile-Image">
                                </c:if>
                                  ...
                                  <div class="user-details">
                                      ...
                                      <span id="more-details"> <%= request.getSession().getAttribute("usuarioNome") %><i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
