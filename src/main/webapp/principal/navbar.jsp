...
<nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img class="img-fluid" src="<%= request.getContextPath() %>/assets/images/OneWeb_Logo.png" style="width: 150px" alt="Theme-Logo" />
                      </a>
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  ...
                                  <span> <%= session.getAttribute("usuarioNome") %></span>
